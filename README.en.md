...
> Installers are published as GitHub **Release assets**; an empty **Packages** section in the repository is normal. The planned v0.2.3 asset names are `quota-assistant_0.2.3_macos_universal.dmg` and `quota-assistant_0.2.3_windows_x64-setup.exe`. Download them from the corresponding Release.
