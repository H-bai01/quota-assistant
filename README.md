...
一个本地优先的 macOS 悬浮额度监控工具，同时显示 Codex 与 Claude 的 5 小时额度、周额度和重置时间。
...
- Codex：读取本机现有 Codex 登录状态，显示套餐、5 小时额度、周额度、重置时间与重置机会。
- Claude：使用应用内独立登录窗口连接 `claude.ai`，显示套餐、5 小时额度、周额度与订阅信息。
...
- 应用只持久化悬浮窗偏好，不复制或持久化账户令牌、Cookie、聊天内容或原始额度响应。
