...
- Windows 是 Beta，尚未完成真实安装、冷启动、紧凑/展开、托盘、拖动、置顶、锁定/解锁、双语、诊断复制、退出、卸载和降级验收；CI 构建、manifest、SBOM、SHA-256 与 attestation 通过不能代替这些证据。
- macOS v0.2.2 已使用精确远端候选附件完成安装、冷启动、核心流程、退出、卸载及降级至 v0.2.1 的真实验收。
- `v0.2.1` 是首个公共 Release；Windows Beta 没有已验证回退路径。
